...
import { EMethods, MonitorHttp, MonitorXMLHttpRequest } from 'encode-yt-monitor-types';
import { voidFun, EventTypes, HttpTypes, HttpCodes } from 'encode-yt-monitor-shared';
