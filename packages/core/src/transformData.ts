import { BreadCrumbTypes, ErrorTypes, globalVar } from 'encode-yt-monitor-shared';
import {
  getLocationHref,
  getTimestamp,
  Severity,
...
import { ReportDataType, MonitorHttp, Replace, ResourceErrorTarget } from 'encode-yt-monitor-types';
