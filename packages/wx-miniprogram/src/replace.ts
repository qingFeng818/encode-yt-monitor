...
import { MonitorHttp, EMethods } from 'encode-yt-monitor-types';
  ...
  hookMethods.forEach((hook) => {
    ...
    Object.defineProperty(wx, hook, {
      ...
      value: function (...args: any[]) {
        ...
        } else if (hook === 'downloadFile') method = EMethods.Get;
        else method = EMethods.Post;
        const { url } = options;
